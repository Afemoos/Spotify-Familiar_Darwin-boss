...
export function Landing({ onCreateClick, onManageClick, onJoinClick }: LandingProps) {
    return (
        <div className="flex flex-col items-center justify-center space-y-8 animate-in fade-in slide-in-from-bottom-5 duration-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-2xl">
                ...
                >
                    ...
                    <h3 className="text-2xl font-bold text-white mb-2">Crear Nuevo Recocho</h3>
                    <p className="text-gray-400 text-center text-sm">
                        Configura equipos, precios y comparte el código
                    </p>
                </button>
